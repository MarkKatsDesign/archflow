...
export const services: Service[] = [
  ...
  },
  {
    ...
    provider: 'Cloudflare',
    description: 'Global content delivery network with 300+ data centers, DDoS protection, and edge caching',
    color: categoryColors.CDN,
    compatibleWith: ['vercel', 'netlify', 'cloudflare-pages', 'aws-s3', 'cloudflare-r2'],
    costModel: {
      type: 'usage',
      baseCost: 0,
      scalingFactor: 2,
    ...
    documentation: 'https://developers.cloudflare.com/cdn/',
  ...
  },
  {
    ...
    category: Category.Backend,
    provider: 'AWS',
    description: 'Fully managed container orchestration service with Fargate serverless compute',
    color: categoryColors.Backend,
    compatibleWith: ['postgres-rds', 'dynamodb', 'redis-elasticache', 'aws-s3', 'aws-sqs', 'aws-sns', 'cloudflare-r2'],
    costModel: {
      type: 'usage',
      baseCost: 30,
      scalingFactor: 3,
      freeTierAvailable: false,
      estimatedMonthlyCost: { min: 30, max: 500 },
    },
    scalability: 5,
    complexity: 4,
    managedLevel: 'fully',
    ...
    tags: ['containers', 'docker', 'fargate', 'orchestration', 'microservices'],
  },
  {
    id: 'gcp-cloud-run',
    name: 'GCP Cloud Run',
  ...
  // Search
  {
    ...
    provider: 'SaaS',
    description: 'Hosted search API with typo-tolerance, faceting, and instant results',
    color: categoryColors.Search,
    compatibleWith: ['vercel', 'netlify', 'cloudflare-pages', 'aws-lambda', 'aws-ecs'],
    costModel: {
      type: 'tiered',
      baseCost: 0,
      scalingFactor: 3,
  ...
  // Monitoring
  {
    ...
    provider: 'SaaS',
    description: 'Unified observability platform with metrics, traces, logs, and APM',
  ...
  },
  {
    ...
    category: Category.Monitoring,
    provider: 'AWS',
    description: 'Native AWS monitoring with metrics, logs, alarms, and dashboards',
    color: categoryColors.Monitoring,
    compatibleWith: ['aws-lambda', 'aws-ecs', 'postgres-rds', 'aws-alb', 'aws-api-gateway'],
    costModel: {
      type: 'usage',
      baseCost: 0,
      scalingFactor: 3,
