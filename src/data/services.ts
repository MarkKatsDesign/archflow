...
export const services: Service[] = [
...

  {
    ...
    provider: "SaaS",
    description:
      "API access to Claude models for text generation, analysis, coding, and agentic tasks. Features large context windows, vision capabilities, and tool use for building AI assistants and automations.",
    color: categoryColors[Category.AIml],
    compatibleWith: [
      "vercel",
      "netlify",
    ...
    costModel: {
      type: "usage",
      baseCost: 0,
      freeTierAvailable: false, // Trial credits exist, but no standing free tier
      estimatedMonthlyCost: { min: 5, max: 5000 },
      lastUpdated: "2026-01",
      pricingUrl: "https://platform.claude.com/docs/en/about-claude/pricing",
      confidence: "high",
      assumptions:
        "Pricing is usage-based per million input and output tokens. Claude Opus 4.5 is the most capable model with higher token rates. Claude Sonnet 4.5 offers a balance of intelligence and speed at moderate pricing. Claude Haiku 4.5 and 3.5 are optimized for speed and cost, with Haiku 3.5 slightly cheaper per token for high-volume workloads. Prompt caching and the Batch API provide significant discounts for repeat prompts and non-time-sensitive tasks. Long-context (up to 1M tokens) on Sonnet 4.x is available at premium rates for very large inputs.",
    },
    scalability: 5,
    complexity: 1,
    managedLevel: "fully",
    ...
    tags: ["genai", "llm", "claude", "ai-assistant", "api", "agents"],
  },

  {
    ...
    provider: "SaaS",
    description:
      "Fully managed vector database for high-performance similarity search. Purpose-built for AI applications including RAG, semantic search, recommendations, and long-term memory for LLM apps.",
    color: categoryColors.Database,
    compatibleWith: [
      "openai",
      "anthropic",
    ...
    costModel: {
      ...
      confidence: "high",
      assumptions:
        "Free tier includes 5GB storage and 2M read/write units per month on serverless indexes. Paid usage on serverless is metered based on storage (per GB-month) and read/write units consumed, scaling with traffic and data size. Standard and Enterprise plans provide dedicated infrastructure, higher performance, and advanced security and compliance features for production and enterprise workloads.",
    },
    scalability: 5,
    complexity: 2,
    managedLevel: "fully",
    ...
    tags: ["vector-database", "embeddings", "rag", "semantic-search", "ai"],
  },

  {
    ...
    provider: "SaaS",
    description:
      "Enterprise AI platform with LLMs optimized for business use cases. Offers text generation, embeddings, reranking, and RAG capabilities with fine-tuning and private deployments.",
    color: categoryColors[Category.AIml],
    compatibleWith: [
      "pinecone",
      "qdrant",
    ...
    costModel: {
      ...
      baseCost: 0,
      freeTierAvailable: true,
      estimatedMonthlyCost: { min: 0, max: 3000 },
      lastUpdated: "2026-01",
      pricingUrl: "https://cohere.com/pricing",
      confidence: "high",
      assumptions:
        "Trial API keys provide limited free usage for development; production keys are billed pay‑as‑you‑go. Generative model pricing is per million tokens: Command A ($2.50 input / $10 output), Command R ($0.15 input / $0.60 output), and Command R7B ($0.0375 input / $0.15 output). Embed 4 is priced at $0.12 per million text tokens and $0.47 per million image tokens. Rerank 4 Fast and Pro are priced at $2.00 and $2.50 per 1K searches respectively. Enterprise plans include private deployments, customization, fine‑tuning, and dedicated support.",
    },
    scalability: 5,
    complexity: 1,
    managedLevel: "fully",
    useCases: ["ai-ml", "enterprise", "saas-mvp", "api-backend"],
    documentation: "https://docs.cohere.com/",
    tags: ["genai", "llm", "embeddings", "rag", "reranking", "enterprise"],
  },

  {
    ...
    provider: "SaaS",
    description:
      "European AI company offering frontier and open-weight LLMs via API. Models range from efficient small models to large flagship models, with function calling, JSON mode, and multilingual support.",
    color: categoryColors[Category.AIml],
    compatibleWith: [
      "vercel",
      "netlify",
    ...
    costModel: {
      ...
      estimatedMonthlyCost: { min: 0, max: 3000 },
      lastUpdated: "2026-01",
      pricingUrl: "https://mistral.ai/products/",
      confidence: "high",
      assumptions:
        "Free access is available through Le Chat Free and limited API trial credits. API pricing is usage-based per million tokens and varies significantly by model family. Mistral Large 3 is the flagship model, with Mistral Medium 3 offering a mid‑tier option. Smaller and open-weight models such as Ministral (3B–14B), Mistral Small 3.2, Mistral 7B, and Mixtral (8x7B, 8x22B) provide cost‑efficient alternatives. Specialized families include Codestral and Devstral for coding, Magistral for reasoning, Pixtral for multimodal vision, Voxtral for speech, and dedicated OCR and embedding models. Fine‑tuning is supported on select models, and tool usage (web search, code execution, image generation, libraries, indexing) is billed separately.",
    },
    scalability: 5,
    complexity: 1,
    managedLevel: "fully",
    useCases: ["ai-ml", "saas-mvp", "api-backend", "enterprise"],
    documentation: "https://docs.mistral.ai/",
    tags: ["genai", "llm", "open-source", "multilingual", "european", "api"],
  },

  {
    ...
    provider: "SaaS",
    description:
      "Ultra-fast LLM inference platform powered by custom LPU (Language Processing Unit) hardware. Delivers industry-leading speed for open-source models, ideal for real-time and latency-sensitive applications.",
    color: categoryColors[Category.AIml],
    compatibleWith: [
      "vercel",
      "netlify",
    ...
    costModel: {
      ...
      confidence: "medium",
      assumptions:
        "Free, rate-limited tier is available for experimentation and development, but not suitable for sustained production traffic. Production pricing follows a tokens-as-a-service model, typically billing primarily on output tokens, with effective per-million-token rates that are optimized for high throughput and low latency. Groq hosts popular open and open-weight models such as Llama 3, Mixtral, and Gemma families. The main differentiator is extremely high tokens-per-second throughput and low latency enabled by Groq’s LPU hardware, rather than offering proprietary foundation models.",
    },
    scalability: 5,
    complexity: 1,
    managedLevel: "fully",
    useCases: ["ai-ml", "saas-mvp", "api-backend", "real-time-app"],
...

  {
    ...
    provider: "SaaS",
    description:
      "High-performance open-source vector database with advanced filtering, payload storage, and hybrid search. Available as managed cloud or self-hosted, ideal for production AI applications.",
    color: categoryColors.Database,
    compatibleWith: [
      "openai",
      "anthropic",
    ...
    costModel: {
      ...
      baseCost: 0,
      freeTierAvailable: true,
      estimatedMonthlyCost: { min: 0, max: 1500 },
      lastUpdated: "2026-01",
      pricingUrl: "https://qdrant.tech/pricing/",
      confidence: "high",
      assumptions:
        "Free tier includes a 1GB shared cluster with no credit card required. All paid usage is billed per 'Qdrant Cloud Usage Unit' across Qdrant Cloud, AWS Marketplace, Azure Marketplace, and Google Cloud Marketplace, typically at $0.01 per unit. Pricing scales dynamically based on cluster configuration, including RAM, CPU, storage, and replication settings, with hourly costs shown in the Qdrant Cloud calculator. Managed Cloud provides fully hosted clusters, while Hybrid Cloud allows running Qdrant on customer infrastructure with a managed control plane. Private Cloud offers isolated or on‑prem deployments. Self‑hosted Qdrant remains free and open-source. Enterprise options include enhanced security, SSO, audit logs, and support SLAs.",
    },
    scalability: 5,
    complexity: 2,
    managedLevel: "fully",
...

  {
    ...
    provider: "SaaS",
    description:
      "Leading voice AI platform for text-to-speech, voice cloning, and dubbing. Offers natural-sounding voices in 30+ languages, real-time streaming, and voice design tools for apps, content, and accessibility.",
    color: categoryColors[Category.AIml],
    compatibleWith: [
      "vercel",
      "netlify",
    ...
    costModel: {
      ...
      confidence: "high",
      assumptions:
        "Free tier includes 10k credits per month, API access, automated dubbing, and up to 3 Studio projects. Starter ($5/mo) includes 30k credits, commercial licensing, instant voice cloning, and expanded Studio features. Pro ($99/mo) includes 500k credits and 44.1kHz PCM audio output via API. Scale ($330/mo) provides 2M credits and multiple workspace seats, while Business ($1,320/mo) includes 11M credits, low‑latency TTS, professional voice clones, and higher concurrency. Enterprise plans offer custom credits, SSO, SLAs, and managed dubbing. Credits are used across TTS, STT, dubbing, and other audio generation features.",
    },
    scalability: 5,
    complexity: 1,
    managedLevel: "fully",
...

  {
    ...
    provider: "SaaS",
    description:
      "Fast, accurate speech-to-text and speech understanding API. Offers real-time and batch transcription, speaker diarization, sentiment analysis, and topic detection for voice applications and analytics.",
    color: categoryColors[Category.AIml],
    compatibleWith: [
      "vercel",
      "netlify",
    ...
    costModel: {
      ...
      confidence: "high",
      assumptions:
        "Free tier includes a one-time $200 credit with access to all public models. Pay‑as‑you‑go pricing varies by model family: Flux and Nova‑3 start around $0.0077/min, Nova‑1/2 at $0.0058/min, and Enhanced/Base at higher rates. Streaming and pre‑recorded transcription are billed identically. Add‑on features such as custom redaction, keyterm prompting, and speaker diarization incur additional per‑minute charges. Text‑to‑speech is billed per 1k characters, and Audio Intelligence tasks are billed per 1k tokens. Growth plans provide prepaid annual credits with discounted rates, while Enterprise plans offer the highest discounts, custom models, increased concurrency, and self‑hosting options.",
    },
    scalability: 5,
    complexity: 1,
    managedLevel: "fully",
